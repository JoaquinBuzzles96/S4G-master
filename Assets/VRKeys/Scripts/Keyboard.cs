...
namespace VRKeys {
	...
	public class Keyboard : MonoBehaviour {
		...
		private IEnumerator Start () {
			...
			//playerSpace.transform.localRotation = Placement.PlacementSettings.
		...
		private void Update () {
            ...
            leftHand.transform.localPosition = lefthandPos.transform.position;
			leftHand.transform.localRotation = lefthandPos.transform.rotation; 

			rightHand.transform.localPosition = rightHandPos.transform.position;
			rightHand.transform.localRotation = rightHandPos.transform.rotation;
        }
